...
public class Program extends ASTNode<ASTNode> implements Cloneable {
   ...
   */
  @Deprecated public Program fullCopy() {
  ...
  public UnknownDecl unknownDecl() {
    ...
    if (unknownDecl_visited) {
      throw new RuntimeException(
          "Circular definition of attr: unknownDecl in class: org.jastadd.ast.AST.SynDecl");
    }
  ...
  public int nodeCount() {
    ...
    if (nodeCount_visited) {
      throw new RuntimeException(
          "Circular definition of attr: nodeCount in class: org.jastadd.ast.AST.SynDecl");
    }
  ...
  public IdDecl getIdDecl(IdUse idUse) {
    ...
    if (getIdDecl_IdUse_visited == null) {
      getIdDecl_IdUse_visited = new java.util.HashSet(4);
    }
    if (getIdDecl_IdUse_values == null) {
      getIdDecl_IdUse_values = new java.util.HashMap(4);
    }
    ASTNode$State state = state();
    ...
    if (getIdDecl_IdUse_visited.contains(_parameters)) {
      throw new RuntimeException(
          "Circular definition of attr: getIdDecl in class: org.jastadd.ast.AST.SynDecl");
    }
  ...
  public Counter idDecls() {
    ...
    if (Program_idDecls_visited) {
      throw new RuntimeException(
          "Circular definition of attr: idDecls in class: org.jastadd.ast.AST.CollDecl");
    }
