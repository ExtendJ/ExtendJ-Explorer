...
public class LangParser extends Parser {
  static public class Terminals {
    ...
    static public final String[] NAMES =
        {"EOF", "ID", "LET", "ASK", "NUMERAL", "MUL", "DIV", "ASSIGN", "IN", "END", "USER"};
  }


  static final ParsingTables PARSING_TABLES =
      new ParsingTables("U9o5aKjFma0KXKyjAFHbeV8eB5omS67KnEZ261Si#5$#OmKK1H#7CvEXDarDR$BrdlkOtDi" +
  ...
  public LangParser() {
    ...
    actions = new Action[] {new Action() {  // [0] program = exp.a
