...
/**
 * @ast node
 * @declaredat /home/gda10jli/Documents/jastadddebugger-exjobb/CalcASM/src/jastadd/calc.ast:11
...
public class Let extends Expr implements Cloneable {
  /**
   * @aspect CodeGen
   * @declaredat /home/gda10jli/Documents/jastadddebugger-exjobb/CalcASM/src/jastadd/CodeGen.jrag:147
   */
  ...
  /**
   * @aspect PrettyPrint
   * @declaredat /home/gda10jli/Documents/jastadddebugger-exjobb/CalcASM/src/jastadd/PrettyPrint.jrag:39
   */
   ...
   */
  @Deprecated public Let fullCopy() {
   ...
   * @apilevel high-level
   */
  @ASTNodeAnnotation.ListChild(name = "Binding") public List<Binding> getBindingList() {
   ...
   * @apilevel high-level
   */
  @ASTNodeAnnotation.Child(name = "Expr") public Expr getExpr() {
   ...
   * @apilevel internal
   */
  protected Set localLookup_String_int_visited;
   ...
   * @attribute syn
   * @aspect NameAnalysis
   * @declaredat /home/gda10jli/Documents/jastadddebugger-exjobb/CalcASM/src/jastadd/NameAnalysis.jrag:12
   */
  @ASTNodeAnnotation.Attribute(kind = ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect = "NameAnalysis", declaredAt = "/home/gda10jli/Documents/jastadddebugger-exjobb/CalcASM/src/jastadd/NameAnalysis.jrag:12")
  public IdDecl localLookup(String name, int until) {
    java.util.List _parameters = new ArrayList(2);
    _parameters.add(name);
    _parameters.add(until);
    if (localLookup_String_int_visited == null) {
      localLookup_String_int_visited = new java.util.HashSet(4);
    }
    if (localLookup_String_int_values == null) {
      localLookup_String_int_values = new java.util.HashMap(4);
    }
    ...
    if (localLookup_String_int_visited.contains(_parameters)) {
      throw new RuntimeException(
          "Circular definition of attr: localLookup in class: org.jastadd.ast.AST.SynDecl");
    }
   ...
   * @attribute inh
   * @aspect NameAnalysis
   * @declaredat /home/gda10jli/Documents/jastadddebugger-exjobb/CalcASM/src/jastadd/NameAnalysis.jrag:10
   */
  /**
   * @attribute inh
   * @aspect NameAnalysis
  ...
  @ASTNodeAnnotation.Source(aspect = "NameAnalysis", declaredAt = "/home/gda10jli/Documents/jastadddebugger-exjobb/CalcASM/src/jastadd/NameAnalysis.jrag:10")
  ...
  public IdDecl Define_lookup(ASTNode _callerNode, ASTNode _childNode, String name) {
    if (_callerNode == getBindingListNoTransform()) {
      ...
      // @declaredat /home/gda10jli/Documents/jastadddebugger-exjobb/CalcASM/src/jastadd/NameAnalysis.jrag:5
      {
