...
/**
 * @ast node
 * @declaredat /home/gda10jli/Documents/jastadddebugger-exjobb/CalcASM/src/jastadd/calc.ast:14
...
public class IdDecl extends ASTNode<ASTNode> implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat /home/gda10jli/Documents/jastadddebugger-exjobb/CalcASM/src/jastadd/PrettyPrint.jrag:35
   */
   ...
   */
  @Deprecated public IdDecl fullCopy() {
   ...
   * @attribute syn
   * @aspect CodeGen
   * @declaredat /home/gda10jli/Documents/jastadddebugger-exjobb/CalcASM/src/jastadd/CodeGen.jrag:171
   */
  @ASTNodeAnnotation.Attribute(kind = ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect = "CodeGen", declaredAt = "/home/gda10jli/Documents/jastadddebugger-exjobb/CalcASM/src/jastadd/CodeGen.jrag:171")
  public String address() {
    ...
    if (address_visited) {
      throw new RuntimeException(
          "Circular definition of attr: address in class: org.jastadd.ast.AST.SynDecl");
    }
  ...
  public int localIndex() {
    ...
    if (localIndex_visited) {
      throw new RuntimeException(
          "Circular definition of attr: localIndex in class: org.jastadd.ast.AST.SynDecl");
    }
   ...
   * @attribute syn
   * @aspect NameAnalysis
   * @declaredat /home/gda10jli/Documents/jastadddebugger-exjobb/CalcASM/src/jastadd/NameAnalysis.jrag:27
   */
  @ASTNodeAnnotation.Attribute(kind = ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect = "NameAnalysis", declaredAt = "/home/gda10jli/Documents/jastadddebugger-exjobb/CalcASM/src/jastadd/NameAnalysis.jrag:27")
  public boolean isMultiplyDeclared() {
    ...
    if (isMultiplyDeclared_visited) {
      throw new RuntimeException(
          "Circular definition of attr: isMultiplyDeclared in class: org.jastadd.ast.AST.SynDecl");
    }
  ...
  @ASTNodeAnnotation.Source(aspect = "NameAnalysis", declaredAt = "/home/gda10jli/Documents/jastadddebugger-exjobb/CalcASM/src/jastadd/NameAnalysis.jrag:26")
  ...
  protected void collect_contributors_Program_idDecls() {
    // @declaredat /home/gda10jli/Documents/jastadddebugger-exjobb/CalcASM/src/jastadd/UserTest.jrag:4
    {
      Program ref = (Program) (program());
      if (ref != null) {
        ref.Program_idDecls_contributors().add(this);
      }
    }
  ...
  protected void contributeTo_Program_idDecls(Counter collection) {
    super.contributeTo_Program_idDecls(collection);
    collection.add(1);
  }
}
