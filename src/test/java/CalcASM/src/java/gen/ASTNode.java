...
public class ASTNode<T extends ASTNode> extends beaver.Symbol implements Cloneable, Iterable<T> {
  ...
  public int numLocals() {
    ...
    if (numLocals_visited) {
      throw new RuntimeException(
          "Circular definition of attr: numLocals in class: org.jastadd.ast.AST.SynDecl");
    }
  ...
  public ASTNode lastNode() {
    ...
    if (lastNode_visited) {
      throw new RuntimeException(
          "Circular definition of attr: lastNode in class: org.jastadd.ast.AST.SynDecl");
    }
  ...
  public ASTNode prevNode(int i) {
    ...
    if (prevNode_int_visited == null) {
      prevNode_int_visited = new java.util.HashSet(4);
    }
    if (prevNode_int_values == null) {
      prevNode_int_values = new java.util.HashMap(4);
    }
    ASTNode$State state = state();
    ...
    if (prevNode_int_visited.contains(_parameters)) {
      throw new RuntimeException(
          "Circular definition of attr: prevNode in class: org.jastadd.ast.AST.SynDecl");
    }
  ...
  public ASTNode prevNode() {
    ...
    if (prevNode_visited) {
      throw new RuntimeException(
          "Circular definition of attr: prevNode in class: org.jastadd.ast.AST.InhDecl");
    }
  ...
  public Program program() {
    ...
    if (program_visited) {
      throw new RuntimeException(
          "Circular definition of attr: program in class: org.jastadd.ast.AST.InhDecl");
    }
  ...
  public UnknownDecl unknownDecl() {
    ...
    if (unknownDecl_visited) {
      throw new RuntimeException(
          "Circular definition of attr: unknownDecl in class: org.jastadd.ast.AST.InhDecl");
    }
