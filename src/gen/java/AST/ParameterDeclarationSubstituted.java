...
/**
 * @ast node
 * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java5/grammar/Generics.ast:33
...
public class ParameterDeclarationSubstituted extends ParameterDeclaration implements Cloneable {
   ...
   */
  public ParameterDeclarationSubstituted treeCopyNoTransform() {
   ...
   */
  public ParameterDeclarationSubstituted treeCopy() {
    doFullTraversal();
    return treeCopyNoTransform();
  }
  /**
  ...
  protected boolean is$Equal(ASTNode node) {
    return super.is$Equal(node)  && (tokenString_ID == ((ParameterDeclarationSubstituted)node).tokenString_ID) && (tokenParameterDeclaration_Original == ((ParameterDeclarationSubstituted)node).tokenParameterDeclaration_Original);    
  }
  /**
...
private void sourceVariableDecl_reset() {
  ...
  public Variable sourceVariableDecl() {
    ...
    sourceVariableDecl_value = getOriginal().sourceVariableDecl();
