...
/**
 * @ast node
 * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java4/grammar/Java.ast:44
...
public class PrimitiveType extends TypeDecl implements Cloneable {
   ...
   * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java4/frontend/QualifiedNames.jrag:109
   */
  ...
  /**
   * @aspect SuperClasses
   * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java4/frontend/TypeAnalysis.jrag:617
   */
...
private void instanceOf_TypeDecl_reset() {
   ...
   * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java4/frontend/TypeAnalysis.jrag:482
   */
  @ASTNodeAnnotation.Attribute
...
private void subtype_TypeDecl_reset() {
  ...
  public boolean subtype(TypeDecl type) {
    ...
    if (!state.IN_CIRCLE) {
      ...
      if (isFinal && num == state().boundariesCrossed) {
        ...
        boolean $tmp = type.supertypePrimitiveType(this);
   ...
   * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java5/frontend/GenericsSubtype.jrag:478
   */
  @ASTNodeAnnotation.Attribute
...
private void strictSubtype_TypeDecl_reset() {
  ...
  public boolean strictSubtype(TypeDecl type) {
    ...
    if (!state.IN_CIRCLE) {
      ...
      if (isFinal && num == state().boundariesCrossed) {
        ...
        state.RESET_CYCLE = true;
        boolean $tmp = type.strictSupertypePrimitiveType(this);
        state.RESET_CYCLE = false;
      }
      state.IN_CIRCLE = false;
      state.INTERMEDIATE_VALUE = false;
   ...
   * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java8/frontend/GenericsSubtype.jrag:398
   */
  @ASTNodeAnnotation.Attribute
  public boolean strictSupertypePrimitiveType(PrimitiveType type) {
    ...
    try {
        if(super.strictSupertypePrimitiveType(type))
          return true;
        return type.hasSuperclass() && type.superclass().isPrimitive() && type.superclass().strictSubtype(this);
      }
    finally {
    }
  }
  /**
   * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java4/frontend/TypeAnalysis.jrag:585
   * @apilevel internal
   */
