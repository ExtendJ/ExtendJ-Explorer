...
/**
 * @ast node
 * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java5/grammar/GenericMethods.ast:7
...
public class ParMethodDecl extends MethodDecl implements Cloneable, Parameterization {
   ...
   * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java5/frontend/Generics.jrag:717
   */
  ...
  /**
   * @aspect LookupParTypeDecl
   * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java5/frontend/Generics.jrag:731
   */
  ...
  /**
   * @aspect LookupParTypeDecl
   * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java5/frontend/Generics.jrag:737
   */
  ...
  /**
   * @aspect LookupParTypeDecl
   * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java5/frontend/Generics.jrag:740
   */
  ...
  /**
   * @aspect TypeCheck
   * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java5/frontend/GenericMethods.jrag:91
   */
  ...
  protected boolean is$Equal(ASTNode node) {
    return super.is$Equal(node)  && (tokenString_ID == ((ParMethodDecl)node).tokenString_ID) && (tokenGenericMethodDecl_GenericMethodDecl == ((ParMethodDecl)node).tokenGenericMethodDecl_GenericMethodDecl);    
  }
  /**
...
private void moreSpecificThan_MethodDecl_reset() {
  ...
  public boolean moreSpecificThan(MethodDecl m) {
    ...
    int num = state.boundariesCrossed;
    boolean isFinal = this.is$Final();
    boolean moreSpecificThan_MethodDecl_value = genericMethodDecl().moreSpecificThan(m instanceof ParMethodDecl ? ((ParMethodDecl)m).genericMethodDecl() : m );
    if (isFinal && num == state().boundariesCrossed) {
