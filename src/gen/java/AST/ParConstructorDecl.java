...
/**
 * @ast node
 * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java5/grammar/GenericMethods.ast:10
...
public class ParConstructorDecl extends ConstructorDecl implements Cloneable {
  ...
  protected boolean is$Equal(ASTNode node) {
    return super.is$Equal(node)  && (tokenString_ID == ((ParConstructorDecl)node).tokenString_ID);    
  }
  /**
