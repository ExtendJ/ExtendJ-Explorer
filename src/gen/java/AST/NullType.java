...
/**
 * @ast node
 * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java4/grammar/Java.ast:46
...
public class NullType extends TypeDecl implements Cloneable {
  /**
   * @aspect PrettyPrint
   * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java4/frontend/PrettyPrint.jadd:906
   */
  ...
  public boolean subtype(TypeDecl type) {
    ...
    if (!state.IN_CIRCLE) {
      ...
      if (isFinal && num == state().boundariesCrossed) {
        ...
        boolean $tmp = type.supertypeNullType(this);
  ...
  public boolean strictSubtype(TypeDecl type) {
    ...
    if (!state.IN_CIRCLE) {
      ...
      if (isFinal && num == state().boundariesCrossed) {
        ...
        state.RESET_CYCLE = true;
        boolean $tmp = type.strictSupertypeNullType(this);
        state.RESET_CYCLE = false;
      }
      state.IN_CIRCLE = false;
      state.INTERMEDIATE_VALUE = false;
