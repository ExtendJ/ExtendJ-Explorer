...
/**
 * @ast node
 * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java5/grammar/GenericMethods.ast:11
...
public class RawConstructorDecl extends ParConstructorDecl implements Cloneable {
  ...
  protected boolean is$Equal(ASTNode node) {
    return super.is$Equal(node)  && (tokenString_ID == ((RawConstructorDecl)node).tokenString_ID);    
  }
  /**
