...
/**
 * @ast node
 * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java8/grammar/LambdaAnonymousDecl.ast:1
 * @production LambdaAnonymousDecl : {@link AnonymousDecl};
...
public class LambdaAnonymousDecl extends AnonymousDecl implements Cloneable {
   ...
   */
  public LambdaAnonymousDecl(Modifiers p0, String p1, List<BodyDecl> p2) {
    setChild(p0, 0);
    setID(p1);
    setChild(p2, 1);
  }
   ...
   */
  public LambdaAnonymousDecl(Modifiers p0, beaver.Symbol p1, List<BodyDecl> p2) {
    setChild(p0, 0);
    setID(p1);
    setChild(p2, 1);
  }
...
private void unqualifiedLookupMethod_String_reset() {
   ...
   * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java8/frontend/EnclosingLambda.jrag:37
   */
  @ASTNodeAnnotation.Attribute
