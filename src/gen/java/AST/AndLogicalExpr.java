...
/**
 * @ast node
 * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java4/grammar/Java.ast:171
...
private void isDAafterTrue_Variable_reset() {
  ...
  public boolean isDAafterTrue(Variable v) {
    ...
    boolean isDAafterTrue_Variable_value = getRightOperand().isDAafterTrue(v) || isFalse();
...
private void isDAafterFalse_Variable_reset() {
  ...
  public boolean isDAafterFalse(Variable v) {
    ...
    int num = state.boundariesCrossed;
    boolean isFinal = this.is$Final();
    boolean isDAafterFalse_Variable_value = (getLeftOperand().isDAafterFalse(v) && getRightOperand().isDAafterFalse(v)) || isTrue();
    if (isFinal && num == state().boundariesCrossed) {
...
private void isDUafter_Variable_reset() {
  ...
  /**
   * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java4/frontend/DefiniteAssignment.jrag:383
   * @apilevel internal
   */
  ...
  /**
   * @declaredat /home/johan/Arbete/JastAddAd/jastaddj/java4/frontend/DefiniteAssignment.jrag:840
   * @apilevel internal
   */
